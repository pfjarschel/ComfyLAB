...
from comfylab.blocks.script_csharp import parse_csharp_decorators, validate_code as validate_csharp
...
PARSER_REGISTRY = {
    ...
    "csharp": parse_csharp_decorators,
    "cs": parse_csharp_decorators,
    "dotnet": parse_csharp_decorators,
}
