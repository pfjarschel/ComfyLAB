...
def parse_wolfram_json_value(val):
    ...
    # Fallback to keep downstream nodes from crashing if the user writes an invalid function
...
@register_node("script/wolfram")
class WolframScriptNode(BaseSubprocessScriptNode):
    icon = "🧠"
