...
class BaseJavaScriptNode(BaseSubprocessScriptNode):
...
class JavaScriptScriptNode(BaseJavaScriptNode):
    icon = "☕"
...
class TypeScriptScriptNode(BaseJavaScriptNode):
    icon = "🟦"
...
if get_config().get("enable_js_scripting", False):
    ...
    register_node("script/typescript")(TypeScriptScriptNode)
