...
logger = logging.getLogger("comfylab.nodes.instruments.devices")


class BaseDeviceConnectNode(BaseNode):
    """
    Base class for device-specific connect nodes. Opens a VISA connection to
    ...
    async def execute(self, context: ExecutionContext, trigger_pin: str) -> Optional[str]:
        ...
        if not address:
            raise ValueError("No address specified for Device Connect node.")
