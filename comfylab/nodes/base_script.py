...
logger = logging.getLogger("comfylab.nodes.base_script")
...
class BaseScriptNode(BaseNode):
    """Abstract base class for all scripting nodes (in-process or subprocess-based)."""
...
class BaseSubprocessScriptNode(BaseScriptNode):
    """Base class for scripting nodes that compile or run user code in an external subprocess."""
    file_extension: str = ""
    executable_name: str = ""
