...
logger = logging.getLogger("comfylab.nodes.math_functions")
...
@register_node("math/functions/gaussian")
...
@register_node("math/functions/lorentzian")
class LorentzianNode(BaseNode):
...
@register_node("math/functions/pulse")
class PulseNode(BaseNode):
...
@register_node("math/functions/step")
...
@register_node("math/functions/triangle")
...
@register_node("math/functions/sawtooth")
class SawtoothNode(BaseNode):
...
@register_node("math/functions/sine")
...
@register_node("math/functions/bessel")
class BesselNode(BaseNode):
...
@register_node("math/functions/polynom")
class PolynomNode(BaseNode):
...
@register_node("math/functions/log")
...
@register_node("math/functions/exponential")
